...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.adf3162f4fab57f191babe1a48f22487c104a70ef950dbffd87c71cd65d6a0cd.js',function(){input.required=false;search();});}
